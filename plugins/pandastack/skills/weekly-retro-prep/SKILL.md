---
name: weekly-retro-prep
description: Pre-fetch all retro inputs, write structured prep file to Inbox/retro-prep-YYYY-Wxx.md. Triggers on /weekly-retro-prep, Hermes cron 0 9 * * 5, manual pdctx call personal:writer "/weekly-retro-prep".
reads:
